...
# BASED ON c:\Document\mon-hoc\Do_an_tot_nghiep\Home_health_care\Hardware\chua_chay
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mfloat-abi=hard>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32F401RCTX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32F401RCTX_FLASH.ld>"
)
