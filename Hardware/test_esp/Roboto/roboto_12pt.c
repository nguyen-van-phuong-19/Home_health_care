 ...
 * Size: 12 px
 * Bpp: 1
 * Opts: --font Roboto-Regular.ttf --size 12 --bpp 1 --format lvgl --range 0x20-0x7E,0xC0-0x17F --lv-include SSD1306_oled.h --lv-font-name roboto_12pt --output roboto_12pt.c
 ******************************************************************************/
